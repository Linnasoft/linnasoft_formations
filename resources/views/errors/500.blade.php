        ...
        <div class="">
            <h1 class="error-number">
              @if($exception->getMessage())
                <img alt="key-icon" width="150px" height="150px" src="{{asset('assets/img/key.svg')}}">
              @else
                <img alt="sad-icon" width="150px" height="150px" src="{{asset('assets/img/sad.png')}}">
              @endif
            </h1>
            <p class="mini-text">Oops !</p>
            <p class="error-text mb-2 mt-1">
              {{ ($exception->getMessage())? $exception->getMessage(): 'Le serveur n\'autorise pas cette action !' }}
            </p>
