...
<body class="error404 text-center">
    ...
    <div class="container-fluid error-content">
        <div class="">
            <h1 class="error-number"><img alt="sad-icon" width="150px" height="150px" src="{{asset('assets/img/bad_network.svg')}}"></h1>
            <p class="mini-text">Oops !</p>
            <p class="error-text mb-4 mt-1">Vérifiez l'état de la connexion ...</p>
            <a href="/" class="btn btn-primary mt-5">Réessayer</a>
        </div>
    </div>    
</body>
</html>
